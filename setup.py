...
version_dict = {}
with open('./walkscore/__version__.py') as version_file:
...
setup(
    ...
    description=('Unofficial Python bindings for the WalkScore API'),  # Required
    ...
    url='https://walkscore-api.readthedocs.io/en/latest',  # Optional
    ...
    keywords='walkscore binding WalkScore API real estate',  # Optional
