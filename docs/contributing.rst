...
.. note::
  ...
  As a general rule of thumb, the **WalkScore** library applies :pep:`PEP 8 <8>`
  styling, with some important differences.
...
**WalkScore** is meant to be a "beautiful" and "usable" library. That means
...
**SQLAthanor** we rely on several tools:
...
#. Fork the `Git repository <https://github.com/insightindustry/walkscore-api>`_.
...
Check for open `issues <https://github.com/insightindustry/walkscore-api/issues>`_
...
.. seealso::
  ...
  For more information about the **WalkScore** testing approach please
  see: :doc:`Testing WalkScore <testing>`
